...
struct TrainFilterDTO: Codable {
    ...
    init(maxResultCount: Int, page: Int, pageSize: Int ,showTrainWithAlarmOnly:Bool, deviceTypeDTOList: [DeviceTypeDTO], selectedDetectorsDTOList: [DetectorDTO], sort:String) {
