...
//
//  Created by Jonas Isaksson on 2019-10-30.
...
class ListAlarmsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, reloadStartViewDelegate {
    var currentPage = 1;
    var totalPages = 0;
    var pageSize = 10;
    ...
    let kLoadingCellTag2 = 1273;
        ...
        func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            let reportAlarm = ReportAlarmViewController()
            reportAlarm.trainListDTO = self.trainListDTO[indexPath.row];
            self.navigationController?.pushViewController(reportAlarm, animated: true);
